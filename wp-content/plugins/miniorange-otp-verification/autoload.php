 ...
 * BuildScript.php updates the package.json file content in the below function to be used further in autoload.php
 */
function initialize_package_json() {
	$package = wp_json_encode( array( "name"=>"miniorange-otp-verification","version"=>"4.2.0","type"=>"MiniOrangeGateway","testmode"=>false,"failmode"=>false,"hostname"=>"https://login.xecurify.com","dcustomerkey"=>"16555","dapikey"=>"fFd2XcvTGDemZvbw1bcUesNJWEqKbbUq","sslverify"=>false,"session"=>"TRANSIENT","typeplan"=>"wp_otp_verification_basic_plan","licensename"=>"WP_OTP_VERIFICATION_PLUGIN" ) );
	return $package;
}
